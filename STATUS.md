...
| 2026-03-27 | Phase 7 | Remote MCP manual-auth endpoint (7.6)                 | Done        | Shipped `/mcp` with four MCP tools and manual `vmf_` bearer auth for private demos; deferred OAuth account linking to the next PR. |
