...
export const GITHUB_URL = "https://github.com/juancopi81/video-moment-finder";
export const API_HOST = "https://api.videomomentfinder.com";
export const SUPPORT_EMAIL = "support@videomomentfinder.com";
