...
export default function SupportPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="font-[family-name:var(--font-heading)] text-4xl font-bold">Support</h1>
      ...
      <div className="mt-8 rounded-xl border border-zinc-200 bg-surface-card p-6 dark:border-zinc-800">
        <h2 className="font-[family-name:var(--font-heading)] text-lg font-bold">Contact Us</h2>
